...
def main():
    ...
    complete_inse = data_inse.combine_data(data_inse.load_data(), data_inse.create_inse_table(), data_inse.create_basic_education_table())

    X_train_scaled, X_test_scaled, y_train, y_test = data_inse.prepare_data(complete_inse)
